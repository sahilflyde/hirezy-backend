...
var _createdWebsiteModel = _interopRequireDefault(require("../models/createdWebsiteModel.js"));
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return regeneratorRuntime.awrap(_createdWebsiteModel["default"].findOne({
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          ...
          _context2.next = 4;
          return regeneratorRuntime.awrap(_createdWebsiteModel["default"].findOneAndUpdate({
            siteId: siteId
          }, {
            siteId: siteId,
    ...
    while (1) {
      switch (_context4.prev = _context4.next) {
        case 0:
          _context4.prev = 0;
          _context4.next = 3;
          return regeneratorRuntime.awrap(_createdWebsiteModel["default"].find().sort({
            createdAt: -1
          }));
    ...
    while (1) {
      switch (_context5.prev = _context5.next) {
        case 0:
          _context5.prev = 0;
          _context5.next = 3;
          return regeneratorRuntime.awrap(_createdWebsiteModel["default"].deleteOne({
            slug: req.params.slug
          }));
